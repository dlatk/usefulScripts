...
"""This script imports a tsv file to a table that it creates
Usage:
tsv2mySQL.py FILE DATABASE TABLENAME 'column description' 
"""
# By Maarten
...
Usage:       tsv2mySQL.py FILE DATABASE TABLENAME '(mysql column description)' [IGNORELINES]
Example:     tsv2mySQL.py example.tsv my_database my_new_table '(id int(10), name varchar(20))' 1
""")
    sys.exit(1)
...
db = MySQLdb.connect(db=database, local_infile = 1,read_default_file='~/.my.cnf')
cur = db.cursor()
